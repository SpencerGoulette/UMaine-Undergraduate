...
C1 = 42*10^(-9);
C2 = 4.2*10^(-9);
% label resistors as 'res1,' 'res2,' 'cap1,' and 'cap2' in your schematic
hspc_set_param('res1', R1, hspc_filename);
hspc_set_param('res2', R2, hspc_filename);
hspc_set_param('cap1', C1, hspc_filename);
hspc_set_param('cap2', C2, hspc_filename);

hspc_addline('.ac dec 201 1e2 1e4', hspc_filename);
