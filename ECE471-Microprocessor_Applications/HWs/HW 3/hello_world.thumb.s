...
_start:
	...
	@                                  \/
	@==========================================
	mov	r6,r0			@ Set counter to 0
incr:
	mov	r0,r6			@ set r0 to the counter to print the counter
	@==========================================
	...
	cmp	r6,#16			@ If counter at the limit, then stop printing
	bne	incr
	@==========================================
...
print_string:
	...
	push    {r0,r2,r3,r7,lr}	@ Save r0,r2,r7,r3,lr on stack
	...
	@                                  \/
	@==========================================
	mov	r2,#0			@ Sets string counter to 0
string_counter:
	ldrb	r0,[r1]			@ Loads character from string
	add	r1,#1			@ Increase pointer to next string character
	add	r2,#1			@ Increment string counter
	cmp	r0,#0			@ If at the end of string then stop looping
	bne	string_counter
	sub	r1,r1,r2		@ Makes pointer point at beginning of the string again
	@==========================================
...
print_number:
	push	{r3,LR}	@ Save r10 and return address on stack
